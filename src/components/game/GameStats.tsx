...
export default function GameStats({ level, score, timeElapsed, colorModel }: GameStatsProps) {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-700/50">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
        ...
        <div className="p-4 bg-gray-900/50 rounded-xl border border-gray-700/50">
          <div className="text-lg font-bold">{colorModel}</div>
          <div className="text-sm text-gray-400 mt-1">Color Model</div>
        </div>
      </div>
    </div>
  )
