		...
		<div className="max-w-3xl mx-auto p-4 sm:p-8 md:p-12 bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md rounded-2xl border border-gray-700/20 shadow-lg hover:shadow-xl transition-all duration-300">
			...
			<div className="space-y-4 sm:space-y-8 text-white/90 mb-4 sm:mb-10 md:mb-12">
				...
				<div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md rounded-xl border border-gray-700/20 hover:border-gray-600/30 transition-all duration-300">
					...
					>
						<h2 className="font-semibold text-base sm:text-xl text-white flex items-center gap-2">
							<svg className="w-5 h-5 text-blue-400" viewBox="0 -960 960 960" fill="currentColor">
					...
					<div className={`overflow-hidden transition-all duration-300 ${expandedSections.howToPlay ? 'max-h-96' : 'max-h-0'}`}>
				...
				<div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md rounded-xl border border-gray-700/20 hover:border-gray-600/30 transition-all duration-300">
					...
					<div className={`overflow-hidden transition-all duration-300 ${expandedSections.whatWeStudy ? 'max-h-96' : 'max-h-0'}`}>
						<div className="p-3 sm:p-4 pt-1">
				...
				<div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-md rounded-xl border border-gray-700/20 hover:border-gray-600/30 transition-all duration-300">
					...
					<div className={`overflow-hidden transition-all duration-300 ${expandedSections.privacy ? 'max-h-96' : 'max-h-0'}`}>
						<div className="p-3 sm:p-4 pt-1">
							<p className="text-sm sm:text-base text-gray-300 leading-relaxed">
