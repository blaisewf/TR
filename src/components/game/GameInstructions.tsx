...
export default function GameInstructions({ onStartGame }: GameInstructionsProps) {
  return (
    <div className="max-w-2xl mx-auto p-10 bg-gray-800/20 backdrop-blur-md rounded-2xl border border-gray-700/20 shadow-lg">
      <h1 className="text-4xl font-bold text-center mb-8 text-white">Color Perception Experiment</h1>

      <div className="space-y-6 text-white/90 mb-10">
        <p className="text-lg text-gray-300">
          Welcome to our interactive color perception study! This experiment investigates how humans perceive color
          differences across various digital color models.
        </p>
        ...
        <div className="bg-gray-800/20 backdrop-blur-md p-6 rounded-xl border border-gray-700/20">
          <h2 className="font-semibold text-xl text-white mb-3">What We're Studying</h2>
          <p className="text-gray-300">
            Different color models (RGB, CIELAB, Oklab, CIECAM02-UCS) represent colors in various ways. We're collecting
            data to understand which models best match human color perception.
          </p>
        </div>
        ...
        <div className="bg-gray-800/20 backdrop-blur-md p-6 rounded-xl border border-gray-700/20">
          ...
          <p className="text-gray-300">
            Your data is collected anonymously. We only store your responses, timing, and basic device information. No
