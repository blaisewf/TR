...
import { generateRandomRGBColor, createPerceptualDifference, getPlayerId } from "@/lib/utils/colorGenerator"
...
import { type GameState, type GameRound, COLOR_MODELS, GRID_SIZE, MAX_WRONG_ANSWERS } from "@/types/game"
